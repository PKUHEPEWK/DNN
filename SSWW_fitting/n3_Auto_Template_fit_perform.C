#include "iostream"
void n3_Auto_Template_fit_perform()
{
    ...
    TKey *key;
    TIter nextkey(fileSignal->GetListOfKeys());
    while((key = (TKey*)nextkey()))
    {
        ...
        //TString HistoName = "lep1pt"; // Removed to be done on iteration of keys
        ...
        //fit->SetRangeX(1,15);  // TODO TODO TODO FIXME FIXME: Perform fitting on given bin range
        ...
        {                       // check on fit status
            ...
            pt->Draw();
            TString Name1 = "Auto_Fitting_" + HistoName + ".pdf";
            cv->SaveAs(Name1);
            ...
            leg->Draw();
            pt->Draw();
            TString Name2 = "Auto_Fitting_" + HistoName + "_log.pdf";
            cv_log->SaveAs(Name2);
            //cv_log->Delete();
