...
class Asimov_Dataset:
    ...
    def Make_AsimovData(self,NLLTarget,NTTTLTarget,BinNum=20):
        ...
        OF = TFile("Asimov_Dataset_forDNN.root","RECREATE")
...
def main():
    infile = "/Users/leejunho/Desktop/git/PKUHEP/DNN/tens_model_class/From_ipnl/High_20181010_TrainENum1000000/LayerNum_7+Node_150+BatchSize_10"  #FIXME

    infileLL = infile + "/TEST_ROOT_LL_tree.root"
    infileTTTL = infile + "/TEST_ROOT_TTTL_tree.root"
    BinNum = 20                           #FIXME
