#!/usr/bin/env python
#TODO Put this under MadGraph's Delphes directory
...
import ROOT
ROOT.gInterpreter.AddIncludePath("/afs/cern.ch/user/j/junho/work/MyAnalysis_IPHC2/CMSSW_8_0_23/src/MG5_aMC_v2_5_5/Delphes")
#ROOT.gROOT.ProcessLine('/afs/cern.ch/user/j/junho/work/MyAnalysis_IPHC2/CMSSW_8_0_23/src/MG5_aMC_v2_5_5/Delphes')
...
#    for entry in range(1000):
        ...
        for lep_order in range(len(lepton_first_pick)):
            if(lep_order==0):
                Leading_lepPT = lepton_first_pick[0].PT;    #print(Leading_lepPT) 
                leading = lep_order
                continue
        ...
        if (lepton_order_list[0].Eta >2.4) | (lepton_order_list[1].Eta >2.4):
            continue
        if (lepton_order_list[0].Charge) != (lepton_order_list[1].Charge):
            continue
        #print(lepton_order_list[0].Charge)
