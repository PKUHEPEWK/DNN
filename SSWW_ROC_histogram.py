...
def ROC_plotter(Roc_list,dirname,verbose=0):
    ...
    if verbose==1:
        ...
        for i,content in enumerate(Roc_list[7]):
...
def main():
    dirname = "/Users/leejunho/Desktop/git/PKUHEP/DNN/tens_model_class/From_ipnl/High_20181105_TrainENum3600000/LayerNum_5+Node_500+BatchSize_100/TEST_TRAIN_ROOT" #FIXME
