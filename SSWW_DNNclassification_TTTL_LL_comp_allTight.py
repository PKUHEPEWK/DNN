...
model = DNN(n_in=22, n_hiddens=[150,150,150,150,150,150,150,150,150,150], n_out=2) #TODO FIXME
#epochs = 100
epochs = 300
earlyStop =  20#20       #TODO FIXME
batch_size = 10        #TODO FIXME
Date=20181115          #TODO FIXME
Layer_NUM= 10             #TODO FIXME
Node_on_Each_layer=150   #TODO FIXME
#N_train = 700000         #TODO FIXME
#N_train = 1500000
N_train = 2600000

Model_name = "AllTight_"+str(Date)+"_"+"TrainENum"+str(N_train)+"/"+"LayerNum_"+str(Layer_NUM)+"+"+"Node_"+str(Node_on_Each_layer)+"+"+"BatchSize_"+str(batch_size)
Make_dir = "mkdir -p "+ "tens_model_class/"+Model_name
os.system(Make_dir)
model_name = Model_name +"/"+ "SSWW_tensor_TTTL-LL_comp"

data = TFile.Open('/sps/cms/jlee/DNN/SSWW_split_input/result/for_DNN/TTTL_LL_4p0M_comparable_2.root') #FIXME
#data = TFile.Open('/pbs/home/j/jlee/DNN/SSWW_split_input/result/for_DNN/TTTL_LL_2p5M_comparable_1.root')
#data = TFile.Open('/pbs/home/j/jlee/DNN/SSWW_split_input/result/for_DNN/TTTL_LL_2p5M_comparable_2.root')
tree = data.Get('tree')
...
('MET',np.float32),('METphi',np.float32),('dr_ll_jj',np.float32),('dphijj',np.float32),('Mjj',np.float32),('RpT',np.float32),
