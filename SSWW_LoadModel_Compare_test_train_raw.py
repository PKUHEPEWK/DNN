...
#    data = TFile.Open('/Users/leejunho/Desktop/git/PKUHEP/DNN/SSWW_split_input/result/for_DNN/TTTL_LL_230M_comparable.root')
    ...
    ARRAY = np.stack((lep1pt, lep1eta, lep1phi, lep2pt, lep2eta, lep2phi, jet1pt, jet1eta, jet1phi,jet2pt, jet2eta, jet2phi, MET, METphi))
    ...
    model = DNN(n_in=14, n_hiddens=[500,500,500,500,500], n_out=2)  ##FIXME TODO
    print("Error test1")
...
def main():
#    infileROOT = "/sps/cms/jlee/DNN/tens_model_class/Raw_20181112_TrainENum1800000/LayerNum_5+Node_500+BatchSize_100/TEST_TRAIN_ROOT/TEST_ROOT_LL.root"
    #infileROOT = "/sps/cms/jlee/DNN/tens_model_class/Raw_20181112_TrainENum1800000/LayerNum_5+Node_500+BatchSize_100/TEST_TRAIN_ROOT/TEST_ROOT_TTTL.root"
#    infileROOT = "/sps/cms/jlee/DNN/tens_model_class/Raw_20181112_TrainENum1800000/LayerNum_5+Node_500+BatchSize_100/TEST_TRAIN_ROOT/TRAIN_ROOT_LL.root"
    #infileROOT = "/sps/cms/jlee/DNN/tens_model_class/Raw_20181112_TrainENum1800000/LayerNum_5+Node_500+BatchSize_100/TEST_TRAIN_ROOT/TRAIN_ROOT_TTTL.root"

    infileROOT = "/pbs/home/j/jlee/DNN/SSWW_split_input/result/for_fitting/PseudoDATA/PseudoDATA_3ab_MERGED.root"

    ModelName = "/sps/cms/jlee/DNN/tens_model_class/Raw_20181112_TrainENum1800000/LayerNum_5+Node_500+BatchSize_100/SSWW_tensor_TTTL-LL_comp_EP60.ckpt" #FIXME
