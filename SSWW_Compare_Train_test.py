...
FileDir = "/Users/leejunho/Desktop/git/PKUHEP/DNN/tens_model_class/High_20180924_TrainENum280000/LayerNum_6+Node_200+BatchSize_100" #FIXME 
...
PSeudoData_TXT = "Ntuple_PseudoData_DECAY_1M_MERGED.txt" #FIXME
...
Infile_list = ("TRAIN_ROOT_LL_tree.root","TEST_ROOT_LL_tree.root","TRAIN_ROOT_TTTL_tree.root","TEST_ROOT_TTTL_tree.root","Ntuple_PseudoData_DECAY_1M_MERGED_tree.root") #FIXME
histoName = ["LL","TTTL"]
HistP = HistProduction(Infile_list)
Hist_files = HistP.MakeHistoROOT(binNum=10,histoName=histoName)  # FIXME Turn this on if histo production required.
print(Hist_files)
